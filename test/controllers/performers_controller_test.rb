...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference("Performer.count") do
      post performers_url, params: { performer: { comedian_id: @performer.comedian_id, live_id: @performer.live_id } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { comedian_id: @performer.comedian_id, live_id: @performer.live_id } }
